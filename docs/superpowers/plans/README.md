...
| 6c | **Discovery** — home feed at `/`, table to `/pool`, member pages | **Implemented** — merged (PR #32) | [`09-m6c-discovery.md`](2026-08-05-09-m6c-discovery.md) | 6a | `/` answers "what is good right now?" |
| 6b | **Playback** — one queue engine: two-layer queue (user intent + pluggable auto-queue), 25-cap, visible drawer, opt-in autoplay, harmonic mix mode | **Implemented** — merged (PR #31), Tasks 1–9 done, no migrations | [`09-m6b-playback.md`](2026-08-05-09-m6b-playback.md) | 6a | Playing a crate fills a visible queue; one tap makes it refill itself harmonically |
...
| — | **UI redesign** — animations, borders, buttons, icons + the audit's top-5 perf sins. Mobile-first. Spec: [`2026-08-06-ui-redesign.md`](../specs/2026-08-06-ui-redesign.md) | **GATED** — plan complete, implementation held by the owner until 6b + 6c are corroborated into one branch. That condition is now **met** (`1d1e1f8`, PR #32); the hold is the owner's to lift. Colours and 90° geometry frozen | [`10-ui-redesign.md`](2026-08-06-10-ui-redesign.md) | 6b + 6c consolidated ✅ | The app looks deliberate and works with a thumb: 44px targets everywhere, cards not tables, a now-playing sheet, `/login` at zero JS |
